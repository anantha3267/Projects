...
ansible-galaxy import <github_user_name> <github_repo_name> --token <your_token> #token from ansible galaxy
...
ansible-playbook 02-playbook.yaml --vault-password-file vault.pass

ansible-vault create aws_creds.yml --vault-password-file vault.pass
